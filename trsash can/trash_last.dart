...
class _AudioClassifierState extends State<AudioClassifier> {
  ...
  void _log(String message) {
    setState(() {
      _logMessages = [message]; // Replace the list with only the latest message
      print(message); // Ensure logs are still printed to the console
    });
  }
          ...
          children: [
            ...
            /*if (_logMessages.isNotEmpty)
              Padding(
                ...
                child: Text(
                  _logMessages[0], // Display only the last log message
                  style: TextStyle(

...
class _AudioClassifierState extends State<AudioClassifier> {
  ...
  // Display only error messages as dropdown dialogs
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          duration: Duration(seconds: 1), // Dismiss after 1 second
        ),
      );
    });
    print(message); // Ensure errors are printed in the console for debugging
  }
